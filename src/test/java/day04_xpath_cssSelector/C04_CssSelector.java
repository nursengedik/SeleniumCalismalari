...
public class C04_CssSelector {
    public static void main(String[] args) throws InterruptedException {
      ...
      //3-  Browseri tam sayfa yapin
        ...
        //ilk ürün denildiği için attribute valusundan sonra index girilir, [1]
        ...
        //locator bulunurken css kullanıldığı için By.cssSelector attribute nü kullandık

        String expectedDeger="25$";
        String actualDeger= ucretElementi.getText();//objeden alacağız
      ...
      /*
        Title testi PASSED
        Hediye kart ucret testi FAILED
        Beklenen deger 25$, gerceklesen deger : $25.00
     */
